...
export class BasketService {
  ...
  addItemToBasket(item: IProduct, quantity = 1 ){
    const itemToAdd: IBasketItem = this.mapProuductItemToBasketItem(item, quantity);
  ...
  private mapProuductItemToBasketItem(item: IProduct, quantity: number): IBasketItem {
    return {
      id: item.id,
